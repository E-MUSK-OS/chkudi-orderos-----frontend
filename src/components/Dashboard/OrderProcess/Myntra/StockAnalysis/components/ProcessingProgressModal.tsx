        ...
        >
          ...
          <div className="flex flex-col items-center text-center space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 max-w-md">
              Cross-verifying Seller SKUs to calculate net stock requirements.
            </p>
          </div>
          ...
          <div className="relative my-8 sm:my-10 flex items-center justify-between px-2 sm:px-6">
            ...
            <div className="relative z-10 flex flex-col items-center gap-2">
              <motion.div
                ...
                className="relative h-20 w-16 sm:h-24 sm:w-20 overflow-hidden rounded-2xl border border-blue-200 bg-white p-2.5 shadow-md flex flex-col justify-between dark:border-blue-500/30 dark:bg-[#161D2E]"
              >
                {/* Mini Blue Scanning Beam */}
                <motion.div
                  animate={{ y: [0, 60, 0] }}
                  transition={{ repeat: Infinity, duration: 1.8, ease: "easeInOut" }}
                  className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-transparent via-blue-500 to-transparent shadow-[0_0_8px_#3B82F6]"
                />

                <div className="flex items-center justify-between border-b border-slate-100 pb-1 dark:border-slate-700">
                  <FileSpreadsheet className="h-4 w-4 text-blue-600" />
                  <span className="text-[9px] font-extrabold text-blue-600">CSV</span>
                </div>
                {/* Simulated Content */}
                ...
                <span className="text-[9px] font-semibold text-slate-500 text-center truncate">Orders</span>
              </motion.div>
              <span className="text-xs font-bold text-[#0A0E1A] dark:text-white">1. Orders File</span>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center gap-2">
              ...
              <span className="text-xs font-bold text-[#B88728] dark:text-[#E8C16D]">2. Auto Calculation</span>
            </div>

            {/* NODE 3: RETURNS FILE CARD */}
            <div className="relative z-10 flex flex-col items-center gap-2">
              <motion.div
                animate={{
                  y: [0, -4, 0],
              ...
              >
                ...
                <div className="flex items-center justify-between border-b border-slate-100 pb-1 dark:border-slate-700">
                  ...
                  <span className="text-[9px] font-extrabold text-amber-600">CSV</span>
                </div>
                <div className="space-y-1 my-auto">
                  <div className="h-1.5 w-full rounded bg-amber-100 dark:bg-slate-700" />
                  <div className="h-1.5 w-3/4 rounded bg-slate-200 dark:bg-slate-700" />
                  <div className="h-1.5 w-5/6 rounded bg-slate-200 dark:bg-slate-700" />
                </div>
                <span className="text-[9px] font-semibold text-slate-500 text-center truncate">Returns</span>
              </motion.div>
              <span className="text-xs font-bold text-[#0A0E1A] dark:text-white">3. Returns File</span>
            </div>
          </div>
            ...
            <div className="flex items-center justify-center">
              <div className="inline-flex items-center gap-2.5 rounded-full border border-[#E8C16D]/30 bg-[#FFF9EC] px-5 py-2 text-xs font-bold text-[#0A0E1A] shadow-sm dark:bg-[#111728] dark:text-white">
                ...
                <span className="truncate max-w-[340px]">
                  {currentStage || "Cross-Verifying SKU quantities..."}
                </span>
              </div>
            </div>
          </div>

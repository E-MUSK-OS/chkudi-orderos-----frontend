    ...
    >
      <div className="p-8">
        <div className="flex flex-col items-center text-center">
          ...
          {/* Title */}
          <h2 className="text-2xl font-bold text-slate-900">Delete Product</h2>
          ...
          <div className="mt-6 flex w-full items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 p-4 text-left">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-amber-700">
                This product and all of its associated variants, inventory
                mappings, and related information will be permanently deleted.
              </p>
            </div>
          </div>
        </div>
